...
const Home = () => {
  ...
  useEffect(() => {
    ...
    console.log(
      "Please Close the debug window pasting anything in here potentialy can damage your device!"
    );
    console.log("%c HOLD UP", "color:red; font-size: 89px;");
    console.log(
      "If you know what you are doing, come work with us for entrys go to the discord channel."
    );
  }, []);
